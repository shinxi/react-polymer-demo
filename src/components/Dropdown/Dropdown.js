...
const propTypes = {
   ...
   * * 'color' - the color to use for the icon - if not specified, the default text colors 
...
const events = [
   ...
   */
  {
    ...
    reactPropName: 'onPxDropdownClick',
  },
  /**
   ...
   */
  {
    ...
    reactPropName: 'onPxDropdownSelectionChanged',
  },
  /**
  ...
  {
    name: 'opened-changed',
    reactPropName: 'onOpenedChanged',
  },
  /**
   * Fired when the `hover` property changes.
   */
  {
    name: 'hover-changed',
    reactPropName: 'onHoverChanged',
  },
  /**
   * Fired when the `displayValue` property changes.
   */
  {
    name: 'display-value-changed',
    reactPropName: 'onDisplayValueChanged',
  },
  /**
   ...
   */
  {
    ...
    reactPropName: 'onSelectedValuesChanged',
  },
];

const options = {
  tagname: 'px-dropdown',
  bowerPath: 'px-dropdown/px-dropdown.html',
  events,
};

const ReactWrapper = withReactWrapper('px-dropdown', options);
